/*
 ...
 Author      : Alaa Elsayed
 Version     : Final Version ( 11 / 09 / 2021 )
 Description : Check the PDF included in the file and also check the mind map representation for more explanation.
 =================================================================================================================
 */

#include <stdio.h>
#include "GlobalVariables_FunctionPrototypes.h"
